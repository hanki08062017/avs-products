...
urlpatterns = [
    ...
    path('seller/view-product/<int:product_id>/', views.view_product, name='view_product'),
    ...
    path('seller/update-order-status/', views.update_order_status, name='update_order_status'),
